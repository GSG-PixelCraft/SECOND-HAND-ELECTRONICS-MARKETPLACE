...
export interface ReportReasonProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'onSelect'> {
...
export const ReportReason = React.forwardRef<HTMLDivElement, ReportReasonProps>(
    (
        {
                        ...
                        <button
                            ...
                            className={cn(
                                ...
                                isSelected
                                    ...
                                    : "border-neutral-20 bg-white hover:border-neutral-30 hover:bg-neutral-5",
                            )}
                        >
