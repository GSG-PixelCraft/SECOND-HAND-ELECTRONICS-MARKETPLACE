...
type CustomerServiceStatusVariantProps = VariantProps<
  typeof customerServiceStatusVariants
>;

export interface CustomerServiceStatusProps extends HTMLAttributes<HTMLSpanElement> {
  status: CustomerServiceStatusVariantProps["status"];
  label?: string;
  showDot?: boolean;
}

export const CustomerServiceStatus = forwardRef<
  HTMLSpanElement,
  CustomerServiceStatusProps
