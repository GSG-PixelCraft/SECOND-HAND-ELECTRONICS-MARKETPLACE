...
export const TopHeader = forwardRef<HTMLDivElement, TopHeaderProps>(
  (
    {
      onMenuClick,
      onSearchClick,
        ...
        <div className="flex items-center gap-3">
          ...
          {showProfile && (
            ...
            >
              ...
              <div className="relative h-9 w-9 overflow-hidden rounded-full border border-neutral-20 bg-neutral-10">
                {userAvatar ? (
                  <Image
                    src={userAvatar}
                    alt={userName}
