...
export interface ToggleControlPanelProps extends React.HTMLAttributes<HTMLDivElement> {
    label: string;
    description?: string;
    enabled: boolean;
...
export const ToggleControlPanel = React.forwardRef<HTMLDivElement, ToggleControlPanelProps>(
    (
        {
            label,
            description,
        ...
        return (
            ...
            >
                <div className="flex-1">
                    ...
                    {description && (
                        <Text variant="caption" className="mt-1 text-neutral-60">
                            {description}
                        </Text>
                    )}
                </div>
