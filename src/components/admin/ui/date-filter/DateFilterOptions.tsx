...
export interface DateFilterOptionsProps extends React.HTMLAttributes<HTMLDivElement> {
...
export const DateFilterOptions = React.forwardRef<HTMLDivElement, DateFilterOptionsProps>(
    (
        {
            selectedValue,
            onSelect,
