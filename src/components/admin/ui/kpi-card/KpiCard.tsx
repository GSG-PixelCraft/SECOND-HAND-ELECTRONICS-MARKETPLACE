    ...
    (
        ...
        if (loading) {
            return (
                <div
                    ref={ref}
                    className={cn(kpiCardVariants({ variant }), "animate-pulse", className)}
                    {...props}
                >
                    <div className="flex items-start justify-between">
                        <div className="flex-1 space-y-3">
                            <div className="h-4 bg-neutral-20 rounded w-24"></div>
                            <div className="h-8 bg-neutral-20 rounded w-32"></div>
                            <div className="h-3 bg-neutral-20 rounded w-20"></div>
                        </div>
                        {icon && (
            ...
            >
                <div className="flex items-start justify-between">
                    <div className="flex-1 space-y-2">
                        <Span variant="caption" className="text-neutral-60 font-medium uppercase tracking-wide">
                            {title}
                        </Span>
