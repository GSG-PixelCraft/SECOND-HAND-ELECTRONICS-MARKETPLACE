export const API_ENDPOINTS = {
  ...
  PRODUCTS: {
    ...
    CREATE: "/products/draft",
    MY: "/products/my",
    CREATE_PENDING: "/products/pending",
    UPDATE_DRAFT: (id: string) => `/products/draft/${id}`,
    UPDATE: (id: string) => `/products/${id}`,
    DELETE: (id: string) => `/products/${id}`,
    ARCHIVE: (id: string) => `/products/archive/${id}`,
    SOLD: (id: string) => `/products/sold/${id}`,
    REPUBLISH: (id: string) => `/products/republish/${id}`,
