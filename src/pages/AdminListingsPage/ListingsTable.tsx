...
export const ListingsTable = React.forwardRef<
  HTMLDivElement,
  ListingsTableProps
>(({ listings, onRowClick, className }, ref) => {
  ...
  const handleViewClick = (e: React.MouseEvent, listingId: string) => {
    e.stopPropagation();
  ...
  return (
    <div ref={ref} className={cn("flex flex-col gap-2", className)}>
      ...
      <div className="flex h-12 items-center overflow-hidden rounded-xl bg-primary/10">
        ...
        <div className="flex flex-1 items-center gap-1 px-4">
          <Span className="text-neutral-90 text-sm font-medium">Category</Span>
          <div className="flex h-4 w-4 items-center justify-center">
            <svg
              width="12"
              height="7"
