...
export const KeyFeaturesCard = React.forwardRef<
  HTMLDivElement,
...
>(({ listing }, ref) => {
  ...
  return (
    <div ref={ref} className="rounded-xl border border-neutral-20 bg-white p-4">
      <h2 className="text-neutral-90 mb-4 text-lg font-medium">Key features</h2>
